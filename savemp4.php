...
if ($yf) {
    foreach ($yf->items as $item) {
        ...
        $sizer = str_replace(':', '.', $sizer); {
            $title = 'Download Lagu ' . $name . ' MP4 - MP3File.Club';
            $discription = 'Download Lagu ' . $name . ' MP4 Baru Secara gratis dan album ' . $name . '';
            $keywords = 'download mp4, ' . $name . ', gratis, mp4 gratis, download video, video gratis, video ' . $name . ', 3gp ' . $name . ', download full album';
        }
        include 'tm-inc/head1.php';
        echo '<div class="bmenu1" align="center"><h3>' . $name . ' Mp4 Information</h3></div>
<div class="list3">
<h3 style="text-align:center">
This song or video is for promotions only
</h3>
<p style="text-align:center">
<b>Click 2x to download MP4</b>
<p />
...
<!-- END ADREACTOR CODE -->
<iframe class="button-api-frame" src="https://youtubemp3api.com/@api/button/videos/' . $id . '" width="100%" height="100%" allowtransparency="true" scrolling="no" style="border:none"></iframe>
<!-- BEGIN ADREACTOR CODE -->
<div id="avp_zid_9">
<script>
_avp.push({ tagid: "avp_zid_9", alias: "/", type: "banner", zid: 9, pid: 6497 });
